...
@AllArgsConstructor
@Entity
@Table(name = "platform_withdrawals", indexes = {
        @Index(name = "idx_platform_withdrawal_status", columnList = "status"),
        @Index(name = "idx_platform_withdrawal_timestamp", columnList = "created_at")
})
